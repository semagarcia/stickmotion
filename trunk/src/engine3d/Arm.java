...
public class Arm extends Group {
	...
	private Vector3f _angFore;
	
	public Arm() {
		_angFore=new Vector3f((float)0,(float)0,(float)0.5);

		//anterior doesn't have transformations, its transformations are done directly in the arm 
    	...
    	fore.translation((float)(Math.sin(_angFore.z)*HEIGHT/2),
    					 -HEIGHT,
