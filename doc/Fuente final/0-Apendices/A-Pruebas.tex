...
\begin{figure}[htb]
  \centerline{\includegraphics[width=\textwidth]{./imagenes/andarResultado.png}}
  \caption{Resultado del ejemplo Andar}
\end{figure}


\begin{figure}[htb]
  \centerline{\includegraphics[width=\textwidth]{./imagenes/andarEscena.png}}
...
\begin{figure}[htb]
  \centerline{\includegraphics[width=\textwidth]{./imagenes/pino3.png}}
\caption{Animación del ejemplo Pino}
\end{figure}
...
\begin{figure}[htb]
  \centerline{\includegraphics[width=\textwidth]{./imagenes/moonwalk2.png}}
  \caption{Animación del ejemplo Moonwalk}
\end{figure}
